export const EFFECT_INFO = {
  ...
  researchGrantFunding: {
    ...
    description: {
      ...
      onRoundChange: 'A research grant will provide a small fixed income of £1,000 per round.',
    },
    type: 'skill',
  ...
  productivityUpgradeMachines: {
    ...
    description: {
      ...
      onOrder: 'Reduces the cost of all manufacturing and production operations by a further 50%.',
    },
    type: 'skill',
  ...
  organisationInstallNewShelves: {
    ...
    ghost: false,
    description: {
      summary: 'Install a new and improved shelving system, allowing more items to be stored.',
  ...
  financeFocus: {
    ...
    description: {
      ...
      onAdd:
        'Costs 2 skill points, but provides your business with an extra £15,000 for immediate use.',
    },
    type: 'skill',
  ...
  financeHireManagementTrainee: {
    ...
    ghost: false,
    description: {
      summary: 'Hire a management trainee, to help improve warehouse organisation and management.',
      onAdd:
        'Costs £5,000 in recruitment expenses, and increases your warehouse capacity by 20 items.',
    },
    type: 'skill',
    siblings: ['financeBase'],
  },
  ...
  financeHireSalesTrainee: {
    ...
    description: {
      ...
      onAdd:
        'Costs £5,000 in recruitment expenses, but instantly boosts your reputation by 2 points.',
    },
    type: 'skill',
    siblings: ['financeBase'],
  },
  ...
  leaseWarehouseContract: {
    ...
    description: {
      ...
      onAdd:
        'Items will be delivered to fill the leased space, and you will receive £5,000 for the lease.',
    },
    type: 'decision',
  },
