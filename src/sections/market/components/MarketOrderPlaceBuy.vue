        ...
        <Tooltip :delayDuration="100" :open="priceRatio < 0.9">
          ...
          <TooltipContent class="!z-[1]">
            <div class="text-sm text-red-500">
              <p>
                Max price set is
                {{ Math.abs((priceRatio - 1) * 100).toFixed(0) }}% below market price.
              </p>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <div>
            ...
            <span class="font-bold">{{ quantity }} {{ itemDefinition.name }}</span> at a maximum
            ...
            <Tooltip :delayDuration="0">
              ...
              <TooltipContent>
                <div class="text-sm text-muted-foreground max-w-64 space-y-2">
                  <p>
                    Placing a buy order does not guarantee a purchase. You are committing to buy if
                    a matching transaction is found.
                  </p>
                  <p>
                    Orders may be partially fulfilled and will continue to be filled by available
                    sale items until completed.
                  </p>
                  <p>
                    The final price may fluctuate with market conditions, but it will never exceed
                    the maximum price you have set.
                  </p>
                </div>
              </TooltipContent>
            </Tooltip>
