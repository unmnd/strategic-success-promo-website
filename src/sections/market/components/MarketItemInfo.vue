          ...
          <Popover>
            ...
            <PopoverContent>
              <div class="flex flex-col gap-2">
                ...
                <div>
                  Bid Price:
                  <span class="font-bold">{{ formatter(highestBuyPrice ?? 0) }}</span>
                </div>

                <div>
                  Ask Price:
                  <span class="font-bold">{{ formatter(lowestSellPrice ?? 0) }}</span>
                </div>
    ...
    <div class="overflow-y-auto flex flex-col gap-4 py-4 pr-2">
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <Card class="flex flex-col">
          ...
          <CardContent class="grow">
            <MarketItemInfoPriceHistoryChart v-if="marketPriceHistory" :data="marketPriceHistory" />
          </CardContent>
        </Card>
      </div>
    </div>
